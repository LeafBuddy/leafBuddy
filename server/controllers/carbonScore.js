...
const access_token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjMyMzE2Mjg5LCJqdGkiOiIwY2FlZjczNGYwODM0MGNlOGU3OWQ4MzgyMDk0ZWY5MyIsInVzZXJfaWQiOjExfQ.wFT6hAcKt04Agspha4ORa5FHfZdx-sZB_QR_dIvZqAs';
...
carbonScore.access = (req, res, next) => {
  ...
  fetch(uri, {
    ...
    .then (data => {
      console.log(data);
      res.locals.carbon_access_token = data;
    });
