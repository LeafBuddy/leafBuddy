...
plaidRouter.get('/transactions', plaidControllers.getTransactions, carbonScore.categories, carbonScore.score, (req, res) => {
  res.status(200).json(res.locals.completelist);
});
